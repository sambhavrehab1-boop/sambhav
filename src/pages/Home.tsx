...
export default function Home() {
    useSEO(
        "Best Rehabilitation Centre in Dehradun",
        "Sambhav Nasha Mukti Kendra is the best Government approved De-Addiction Centre in Dehradun. Specialized treatment for Alcohol, Drug, and Substance Abuse."
    );
    return (
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                    <div className="relative z-10 order-2 lg:order-1">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <a
                                ...
                                className="inline-flex justify-center items-center gap-2 bg-orange-600 text-white font-bold px-8 py-4 rounded-full shadow-lg hover:bg-orange-700 transition-colors hover:scale-105 active:scale-95 duration-200"
                            >
                            ...
                            <Link to="/services">
                                <span
                                    className="inline-flex justify-center items-center gap-2 bg-white text-gray-800 font-bold px-8 py-4 rounded-full border-2 border-orange-100 hover:border-orange-500 hover:text-orange-600 transition-all cursor-pointer w-full sm:w-auto hover:scale-105 active:scale-95 duration-200"
                                >
                                    Our Seva (Services)
                                </span>
                            </Link>
                    ...
                    <div className="relative order-1 lg:order-2">
                        <div className="relative rounded-t-[10rem] rounded-b-[3rem] overflow-hidden border-4 border-white shadow-2xl">
                            <img
                                src="/sambhav-rehab-building.webp"
                        ...
                        <div
                            className="absolute -bottom-6 -left-6 bg-white p-5 rounded-xl shadow-xl hidden md:block border-l-4 border-orange-500 animate-slide-up"
                        >
            ...
            <section className="py-20 px-6 bg-stone-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            { img: "/nasha-mukti-kendra-dormitory.webp", title: "Hygienic Living" },
                            { img: "/meditation-session-dehradun.webp", title: "Holistic Healing" },
                            { img: "/sambhav-signage-exterior.webp", title: "Peaceful Environment" }
                        ].map((item, idx) => (
